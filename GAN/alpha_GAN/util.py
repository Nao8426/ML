...
def output_env(filepath, batch_size, nz, opt_para_G, opt_para_D, opt_para_E, opt_para_CD, gen_model, dis_model, enc_model, cdis_model):
    ...
    text_opt_E = 'Encoder ==> lr: {}, betas: {}, weight_decay: {}\n'.format(opt_para_E['lr'], opt_para_E['betas'], opt_para_E['weight_decay'])
    text_opt_CD = 'CodeDiscriminator ==> lr: {}, betas: {}, weight_decay: {}\n\n'.format(opt_para_CD['lr'], opt_para_CD['betas'], opt_para_CD['weight_decay'])
